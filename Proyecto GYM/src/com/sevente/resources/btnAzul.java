...
public class btnAzul extends JButton{
    ...
    protected void paintComponent(Graphics g) {
		...
		if (!model.isEnabled()) {
			...
			if (model.isRollover()) {
						...
						true);
                             ...
                             GP = new GradientPaint(0, 0, btnNormalColor, 0, h, btnNormalColor, true);
                        }
		}
		...
		if (model.isPressed()) {
                    ...
                    */
                    ...
                    p2 = new GradientPaint(0, 1, btnPressedborder, 0, h - 3,
                    		btnPressedborder);
		} 
                else {
                    ...
                    p1 = new GradientPaint(0, 0, btnNormalBorder, 0, h - 1,
					btnNormalBorder);
                    
                    p2 = new GradientPaint(0, 1, btnNormalBorder, 0, h - 1,
                                        btnNormalBorder);
		}
    ...
    public Color getBtnNormalBorder() {
        return btnNormalBorder;
    }

    public void setBtnNormalBorder(Color btnNormalBorder) {
        this.btnNormalBorder = btnNormalBorder;
    }
    ...
    public Color getBtnPressedborder() {
        return btnPressedborder;
    }

    public void setBtnPressedborder(Color btnPressedborder) {
        this.btnPressedborder = btnPressedborder;
    }

    public Color getBtnDisableBoton() {
        return btnDisableBoton;
    }

    public void setBtnDisableBoton(Color btnDisableBoton) {
        this.btnDisableBoton = btnDisableBoton;
    }
